...
const icons: Icon[] = [
  {
    url: "https://linkedin.com/in/bartoszlegiec/",
    alt: "LinkedIn",
    icon: (
  ...
  {
    url: "https://signal.me/#eu/ulyB67sx_fggqrfzOiZoOlyKf56cwTXFNjennB83Ty9kcamDydhKr5j6cy-Sl9aR",
    alt: "Signal",
    icon: (
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 130 130">
        <path d="M11 5h84.96C110.341 5 122 16.6589 122 31.04c0 8.0492-3.745 15.7204-10.209 20.653L63.3328 89H119v36H34.04C19.6589 125 8 113.341 8 98.96c0-8.1825 3.8471-15.7373 10.1439-20.6031L66.6672 41H11V5Z" />
      </svg>
    ),
    allowReferrer: true,
  },
  ...
  return (
    <div className="w-full h-[100vh] flex items-center justify-center">
      <video
        ...
        loop
        autoPlay
        className="max-w-full max-h-full w-full object-fill"
      >
        <source src="/spain.mp4" type="video/mp4" />
      </video>
      <nav className="absolute bottom-6 right-6 flex gap-5">
        {icons.map((i) => (
          <a
            key={i.url}
            target="_blank"
            href={i.url}
            rel={i.allowReferrer ? undefined : "noreferrer"}
            className="fill-slate-50 text-slate-50 opacity-50 hover:opacity-100 focus:opacity-100 transition-opacity duration-75 no-underline"
          >
            <div
              aria-hidden
              className="[&_svg]:fill-inherit [&_svg_*]:fill-inherit [&_svg]:h-12 [&_svg]:w-12"
            >
              {i.icon}
            </div>
