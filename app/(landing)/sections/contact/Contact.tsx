    ...
    <>
      {ICONS.map((i) => (
        <a
          ...
          href={i.url}
          className={cn(
            "[&_svg]:fill-current [&_svg_*]:fill-current text-foreground opacity-50 hover:opacity-100 focus-visible:opacity-100 transition-opacity duration-75 no-underline min-h-0 aspect-square",
            className
          )}
        >
          <div
...
const ICONS: Icon[] = [
  ...
  {
    url: "https://cal.com/bartek-legiec/open",
    alt: "Book a Meeting",
    icon: (
      <Calendar className="!fill-none stroke-current [&_*]:!fill-none [&_*]:stroke-current" />
    ),
  },
  {
