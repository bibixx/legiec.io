    ...
    <>
      {icons.map((i) => (
        <a
          ...
          href={i.url}
          className={cn(
            "text-foreground opacity-50 hover:opacity-100 focus-visible:opacity-100 transition-opacity duration-200 no-underline min-h-0 aspect-square focus-visible:outline-offset-2 rounded-sm",
            className
          )}
        >
          <div
